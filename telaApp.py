...
class TelaApp(Cria_Arquivo_Txt, Id_Google, Decisao, Deletar):
    def __init__(self, master=None):
        ...
        self.texto_saida_parametros = ScrolledText(self.panedwindow1)
        self.texto_saida_parametros.pack(side='top')
        self.panedwindow1.add(self.texto_saida_parametros, weight='1')
        ...
        self.text1.configure(background='#404040', foreground='#ffff00', height='10', width='50')
        _text_ = '''Saidas...'''
